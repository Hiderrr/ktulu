...
client.once('ready', () => {
    ...
    client.mainKtuluText = client.guild.channels.cache.find(channel => (channel.name == client.mainKtuluTextName && channel.type == 'GUILD_TEXT'));
    client.mainKtuluVc = client.guild.channels.cache.find(channel => (channel.name == client.mainKtuluVcName && channel.type == 'GUILD_VOICE'));
});
